...
#   Denesse Citlaly Gomez, 5/30/24,Created Script
#   <Denesse Citlaly Gomez>,<5/30/24>,<Assignment 06>
# ------------------------------------------------------------------------------------------ #
import json
...
class FileProcessor:
    ...
    Denesse Citlaly Gomez,5/30/24,Created Class
    """
...
class IO:
    ...
    def output_menu(menu: str):
        ...
        ChangeLog: (Who, When, What)
        Denesse Citlaly Gomez, 5/30/24,Created function
